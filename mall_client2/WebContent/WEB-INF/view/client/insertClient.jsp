                    ...
                    <div class="border border">
                        ...
                        <form action="${pageContext.request.contextPath}/InsertClientController" method="post">
                            <fieldset class="p-4 font-weight-bolder">
	                            ...
	                            Mail: <input type="text" required pattern="^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}$" name="clientMail" placeholder="*input your mail." class="border p-3 w-100 my-2">                                
                                Password: <input type="password" required pattern="^[A-Za-z0-9]{4,16}$" name="clientPw" placeholder="*only 4-16 English letters and numbers are allowed." class="border p-3 w-100 my-2">
